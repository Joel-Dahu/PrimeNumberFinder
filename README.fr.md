...
- **GENERER UNE LISTE DE NOMBRES PREMIERS** (entre un début et une fin donnée) **ET ELIMINATION DES FAUX POSITIFS (JAVA 8+) :** ***Main_List_Of_Prime_Number.java***

- **TESTEZ SI UN NOMBRE EST PREMIER (JAVA 8+) :** ***Main_Prime_Number_Test.java***<br>
